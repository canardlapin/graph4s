...
object SignedAffinity:
  ...
  extension (affinity: SignedAffinity) inline def value: Double = affinity
...
object NonNegativeAffinity:
  ...
  extension (affinity: NonNegativeAffinity) inline def value: Double = affinity
...
object PositiveAffinity:
  ...
  extension (affinity: PositiveAffinity) inline def value: Double = affinity
